...
- (UIBarButtonItem *)historyBarButtonItem {
    if (!_historyBarButtonItem) {
        _historyBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[INSTomatoBundle imageNamed:@"ins_statistics_barchart"] style:UIBarButtonItemStylePlain target:self action:@selector(clickHistoryButton:)];
    }
...
- (UIBarButtonItem *)closeBarButtonItem {
    if (!_closeBarButtonItem) {
        _closeBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[INSTomatoBundle imageNamed:@"ins_close"] style:UIBarButtonItemStylePlain target:self action:@selector(clickCloseButton:)];
    }
...
- (UILabel *)descriptionLabel {
    if (!_descriptionLabel) {
        ...
        _descriptionLabel.font = [UIFont fontWithName:self.specialFontName size:18];
...
- (UILabel *)dateLabel {
    if (!_dateLabel) {
        ...
        _dateLabel.font = [UIFont fontWithName:self.specialFontName size:14];
