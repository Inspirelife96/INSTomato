...
// 当前激活的任务
extern NSString *const kTomatoConfigurationTableActivedTask;

// 是否支持特殊字体
extern NSString *const kTomatoConfigurationTableIsSpecialFontOptionEnabled;
extern NSString *const kTomatoConfigurationTableSpecialFontName;
extern NSString *const kTomatoConfigurationTableSpecialFontResourcePath;

// 是否支持白噪音
extern NSString *const kTomatoConfigurationTableIsMusicOptionEnabled;
