...
- (instancetype)initWithTaskName:(NSString *)name musicName:(NSString *)musicName colorEnum:(INSSupportedColor)colorEnum tomatoMinutesEnum:(INSSupportedTomatoMinutes)tomatoMinutesEnum restMinutesEnum:(INSSupportedRestMinutes)restMinutesEnum NS_DESIGNATED_INITIALIZER;
