...
- (void)playMusic:(NSString *)musicName {
    ...
    self.musicPlayer = [[AVAudioPlayer alloc] initWithContentsOfURL:[INSMusicHelper musicUrlByName:musicName] error:nil];
...
- (NSArray *)musicNameArray {
    if (!_musicNameArray) {
        _musicNameArray = [INSMusicHelper musicNameArray];
    }
