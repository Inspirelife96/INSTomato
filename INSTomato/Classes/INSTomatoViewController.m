...
- (void)updateButtonsUI {
    ...
    if (timerMode == INSTomatoTimerModeWork) {
        ...
        [_startButton setTitle:@"逸·开始" forState:UIControlStateNormal];
...
- (void)clickTaskButton:(id)sender {
    [[INSBackgroundImageManager sharedInstance] configBackgroundImage:self.view];
...
- (void)updateTaskPageViewControllers {
    ...
    INSTaskModel *activedTask = [[INSTomatoConfigurationTableManager sharedInstance] activedTask];
    
    NSInteger indexOfTask = [[INSTaskTableManager sharedInstance] indexOfTask:activedTask];
    
    if (indexOfTask >= 0) {
        self.pageControl.currentPage = indexOfTask;
    } else {
...
- (UIImageView *)backgroundImageView {
    if (!_backgroundImageView) {
        ...
        if ([[INSTomatoConfigurationTableManager sharedInstance] backgroundImage]) {
            _backgroundImageView.image = [[INSTomatoConfigurationTableManager sharedInstance] backgroundImage];
        } else {
...
- (UIButton *)taskButton {
    if (!_taskButton) {
        ...
        [_taskButton setImage:[INSTomatoBundle imageNamed:@"ins_task"] forState:UIControlStateNormal];
...
- (UIButton *)statisticsButton {
    if (!_statisticsButton) {
        ...
        [_statisticsButton setImage:[INSTomatoBundle imageNamed:@"ins_statistics"] forState:UIControlStateNormal];
...
- (UIButton *)bookmarkButton {
    if (!_bookmarkButton) {
        ...
        [_bookmarkButton setBackgroundImage:[INSTomatoBundle imageNamed:@"ins_bookmark"] forState:UIControlStateNormal];
...
- (UIButton *)startButton {
    if (!_startButton) {
        ...
        [_startButton setTitle:@"勤·开始" forState:UIControlStateNormal];
        [_startButton.titleLabel setFont:[UIFont fontWithName:self.specialFontName size:24]];
...
- (UIButton *)pauseButton {
    if (!_pauseButton) {
        ...
        [_pauseButton.titleLabel setFont:[UIFont fontWithName:self.specialFontName size:24]];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton.titleLabel setFont:[UIFont fontWithName:self.specialFontName size:24]];
...
- (UIButton *)resumeButton {
    if (!_resumeButton) {
        ...
        [_resumeButton.titleLabel setFont:[UIFont fontWithName:self.specialFontName size:24]];
...
- (UIButton *)skipButton {
    if (!_skipButton) {
        ...
        [_skipButton.titleLabel setFont:[UIFont fontWithName:self.specialFontName size:24]];
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        [_closeButton setImage:[INSTomatoBundle imageNamed:@"ins_close"] forState:UIControlStateNormal];
