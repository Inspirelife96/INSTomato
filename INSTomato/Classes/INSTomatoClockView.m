...
@property(nonatomic, assign) NSString *specialFontName;
...
- (void)drawProgressLabel {
    ...
    UIFont *textFont = [UIFont fontWithName:self.specialFontName size: TEXT_NAME_SIZE];
...
- (void)drawStatusLabel {
    ...
    UIFont *taskNameFont = [UIFont fontWithName:self.specialFontName size: fontSize];
    ...
    while (taskNameSize.width > (self.frame.size.width - 20)) {
        fontSize -= 2;
        taskNameFont = [UIFont fontWithName:self.specialFontName size: fontSize];
    ...
    UIFont *dateFont = [UIFont fontWithName:self.specialFontName size: TEXT_DATE_SIZE];
