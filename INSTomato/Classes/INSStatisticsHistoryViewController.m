...
- (void)clickChartModeButton:(id)sender {
    ...
    if (self.chartMode == INSChartModeBar) {
        ...
        [self.chartModeButtonItem setImage:[INSTomatoBundle imageNamed:@"ins_statistics_barchart"]];
    } else {
        self.chartMode = INSChartModePie;
        [self.chartModeButtonItem setImage:[INSTomatoBundle imageNamed:@"ins_statistics_piechart"]];
    }
}
...
- (UIBarButtonItem *)backBarButtonItem {
    if (!_backBarButtonItem) {
        _backBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[INSTomatoBundle imageNamed:@"ins_back"] style:UIBarButtonItemStylePlain target:self action:@selector(clickBackButton:)];
    }
...
- (UIBarButtonItem *)chartModeButtonItem {
    if (!_chartModeButtonItem) {
        _chartModeButtonItem = [[UIBarButtonItem alloc] initWithImage:[INSTomatoBundle imageNamed:@"ins_statistics_piechart"] style:UIBarButtonItemStylePlain target:self action:@selector(clickChartModeButton:)];
